        ...
        public async Task<IActionResult> Register(RegisterNewUserViewModel model)
        {
            if (this.ModelState.IsValid)
            {
                ...
                if (user == null)
                {
                    ...
                    {
                        this.ModelState.AddModelError(string.Empty, "Nao foi possivel registar");
                        return this.View(model);
                    }
                    ...
                    this.ModelState.AddModelError(string.Empty, "O utilizador não está registado");
                    return this.View(model);
                }

                this.ModelState.AddModelError(string.Empty, "Utilizador registado");
            }
